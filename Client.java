...
public class Client{
	...
	public Client() {
		...
		Color c = new Color(153, 255, 0);
		Color h = new Color(223, 115, 255);
		setupButton.setBackground(c);
		playButton.setBackground(h);
		pauseButton.setBackground(h);
		tearButton.setBackground(c);
	...
	class playButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e){
			...
			System.out.println("You are watching the video!"); 
	...
	class tearButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e){
			...
			System.out.println("You decided to stop watching!");  
