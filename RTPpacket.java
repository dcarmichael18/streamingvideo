//javadoc: actual files
//junit: executable class
//README: explanation text document (look up markdown)
//license: ?????
...
public class RTPpacket{
	...
	public RTPpacket(int PType, int Framenb, int Time, byte[] data, int data_length){
		...
		header[0]  = (byte) 256; //10 0 0 0000
		header[1]  = (byte) 26;  //0 0011010
		...
		header[8]  = (byte) ((7777777 & 0xff000000) >> 24);
		header[9]  = (byte) ((7777777 & 0x00ff0000) >> 16);
		header[10] = (byte) ((7777777 & 0x0000ff00) >> 8);
		header[11] = (byte) (7777777 & 0x000000ff);
		//4-byte integer conversion from:
